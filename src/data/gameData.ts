    ...
    steps: [
      {
        ...
        choices: [
          ...
          },
          {
            id: 't1_s1_b',
            label: '只拍照留档',
            desc: '快速拍照记录现状，节省时间便于后续详查——在有限资源下做出务实选择。',
            style: 'compromise',
            deltas: { reputation: 2, risk: 3, evidence: 4, budget: 0 },
            miniGame: { type: 'memory', difficulty: 1, prompt: '记住壁画受潮位置的分布格局后复原',
              narrativeBinding: '你快速浏览壁画受潮区域，试图记住关键潮湿点的分布。裂缝、盐析、起甲——你能在脑中重构出整面壁画的状态吗？' },
